...
sim1_mod # it is not just the coefficients printed
str(sim1_mod) # show everything, but we are not interested in all that info
...
# Add predictions and residuals using modelr
(df <- sim1 %>%
